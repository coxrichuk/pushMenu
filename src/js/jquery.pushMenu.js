...
;(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        ...
        init: function () {
            ...
            var self = this;
            this.levels.forEach( function( element, i ) { element.setAttribute( 'data-level', self.getLevelDepth( element, self.element.id, 'mp-level' ) ); });
            // the menu items
            this.menuItems = Array.prototype.slice.call( this.element.querySelectorAll( 'li' ) );
            // if type == "cover" these will serve as hooks to move back to the previous level
            this.levelBack = Array.prototype.slice.call( this.element.querySelectorAll( '.' + this.settings.backClass ) );
        ...
        _setTransform : function( val, el ) {
            ...
            if(false !== this.isIE() && this.isIE() <= 9)    {
                ...
                translate = 'translate3d(' + val + 'px,0,0)';
